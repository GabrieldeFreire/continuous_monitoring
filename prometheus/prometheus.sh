...
cat ./prometheus/prometheus.yml | tee /etc/prometheus/prometheus.yml
cat ./prometheus/prometheus.rules.yml | tee /etc/prometheus/prometheus.rules.yml
cat ./prometheus/prometheus.service | tee /etc/systemd/system/prometheus.service
